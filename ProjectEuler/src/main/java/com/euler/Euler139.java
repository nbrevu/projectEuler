...
public class Euler139 {
	...
	private static long solve()	{
		long result=0;
		for (Triangle triple:PythagoreanTriples.getSimpleTriplesWithPerimeterLimit(LIMIT)) if ((triple.c%(triple.a-triple.b))==0) result+=LIMIT/(triple.a+triple.b+triple.c);
		return result;
	}
