...
public class Euler768_10 {
	private final static int CANDLES=20;//20;
	private final static int HOLES=360;//360;
	...
	private static class CompatibilitySummary	{
		...
		public List<BitSet> getFullSolutions(SortedPartition p)	{
			// Remove this first line to try a partial brute force approach.
			if (p.pieces.size()>=0) return List.of();
