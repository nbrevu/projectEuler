...
public class Euler653 {
	...
	private final static long L=1_000_000_000;
	private final static int N=1_000_001;
	private final static int J=500_001;
	...
	public static void main(String[] args)	{
		...
		for (;;)	{
			...
			long eventTime=nextEvents.getKey().longValue();
			long elapsedTime=eventTime-currentTime;
			currentTime=eventTime;
			IntSet affectedBalls=nextEvents.getValue();
			for (int i=0;i<=lastPresentBall;++i) balls[i].move(elapsedTime);
