...
public class Euler310_4 {
	...
	private static int countLosingPositions(long limit,Simulator sim)	{
		...
		for (long[] pos:new PositionGenerator(limit))	{
			Simulator.Winner winner=sim.simulate(pos);
			if (winner==Simulator.Winner.NEXT_PLAYER) System.out.println(Arrays.toString(pos));
			EulerUtils.increaseCounter(counter,winner);
		}
	...
	public static void main(String[] args)	{
		...
		System.out.println(countLosingPositions(29,sim));
	}
}
