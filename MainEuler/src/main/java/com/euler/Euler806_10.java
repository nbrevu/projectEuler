	...
	private static long combinationCalculator(int n)	{
		...
		while (x>1)	{
			if ((x&1)==1)	{
				...
				else transResult=transResult.combine(current,noPred,false);
			}
		...
		result/=2;
		result*=LongMath.pow(2l,n)-1;
		return result;
	}
	
	public static void main(String[] args)	{
		System.out.println(combinationCalculator(26));
	}
}
