...
public class Euler592_2 {
	// Variante para comprobar el caso del problema 160.
	private final static class Generator	{
		private BigInteger f;
		private final static BigInteger TEN=BigInteger.valueOf(10);
		private final static BigInteger MOD=BigInteger.valueOf(10000);
		public Generator()	{
			f=BigInteger.ONE;
		}
		public long getNext(long l)	{
			...
			f=f.multiply(bl);
			for (;;)	{
				BigInteger[] results=f.divideAndRemainder(TEN);
