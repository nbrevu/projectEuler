...
public class Euler702_2 {
	...
	*/
	...
	public static void main(String[] args)	{
		for (int i=1;i<=10;++i)	{
			Map<CoordinateTriangleIdentifier,AbstractTriangleIdentifier> triangles=getTrianglesMap(i);
			System.out.println("For i="+i+":");
			System.out.println(String.format("\tExpected %d total triangles, found %d.",6*i*i,triangles.size()));
			System.out.println(String.format("\tExpected %d abstract triangles, found %d.",(i*(i+1))/2,new HashSet<>(triangles.values()).size()));
		}
