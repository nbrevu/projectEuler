...
Finally, the equation $M'x'=v$ is solvable, and yes I used gaussian elimination in Java because why not. So we get the solution $x'$, append the $x_{40}=1$, and divide by $\sum_ix_i$ to get a normalized solution. Then we search for the three squares with highest probability, and done.
