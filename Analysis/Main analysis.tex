...
\textbf{Programming techniques used}: inclusion-exclusion.
...
\begin{itemize}
\item First and foremost we identify one way in which any number $\dfrac1{n^2}$ (for $2\leq n\leq80$) can be expressed as sum of values of the form $\dfrac a{m^2}$.
